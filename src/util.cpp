...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "x.conf"));
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    {
        // Don't overwrite existing settings so command line settings override x.conf
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "xd.pid"));
